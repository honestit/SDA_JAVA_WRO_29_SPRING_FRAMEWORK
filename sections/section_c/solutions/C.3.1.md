Uzupełniony plik `pom.xml` o wymagane zależności do Spring Security. Zwróć uwagę, że wyprowadziliśmy parametr, który określa wersję zależności dla Spring Security.
